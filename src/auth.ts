...
export function getSetupStatus(client: HttpClient): Promise<{ setup_required: boolean }> {
...
export function mfaVerify(
	...
	return client.post('/api/admin/auth/mfa-verify', { challenge_token: challengeToken, code });
}
