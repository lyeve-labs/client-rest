...
export function testWebhook(
  ...
  return client.post<WebhookTestResult>(
...
export function listDeliveries(
  ...
  return client.get<WebhookDelivery[]>(
    `/api/admin/webhooks/${encodeURIComponent(id)}/deliveries?limit=${limit}`,
  );
}
...
export function rotateSecret(
  ...
  return client.post<Webhook>(
    `/api/admin/webhooks/${encodeURIComponent(id)}/rotate-secret`,
    {
...
export function getDeadLetter(
  ...
  return client.get<DeadLetter>(
    `/api/admin/webhook-dead-letters/${encodeURIComponent(id)}`,
  );
}
...
export function deleteDeadLetter(
  id: string,
  client: HttpClient,
): Promise<void> {
...
export function getRetryConfig(
  ...
  return client.get<RetryConfig>(
    `/api/admin/webhooks/${encodeURIComponent(id)}/retry-config`,
  );
}
...
export function getWebhookHealth(
  ...
  return client.get<WebhookHealthStats>(
    `/api/admin/webhooks/${encodeURIComponent(id)}/health`,
  );
}
